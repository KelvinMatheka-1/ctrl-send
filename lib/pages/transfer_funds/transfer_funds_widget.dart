                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: [
                          FFLocalizations.of(context).getText(
                            'w4smsh2i' /* Locked Funds Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            '6uxty3hy' /* Normal Funds transfer */,
                          )
                        ],
                        onChanged: (val) =>
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final textFieldTransferResponse = snapshot.data!;
                          return TextFormField(
                            controller: _model.textController1,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'ynie0pc5' /* recipient id */,
                              ),
                        ...
                        child: Align(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final buttonTransferResponse = snapshot.data!;
                              return FFButtonWidget(
                                onPressed: () async {
                                  await TransactionsTable().insert({
                                    'sender_id': currentUserUid,
                                    'recipient_id': _model.textController1.text,
