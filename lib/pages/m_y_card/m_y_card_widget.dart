  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color(0xFF15DC4F),
        elevation: 8.0,
        child: Icon(
          Icons.add_rounded,
